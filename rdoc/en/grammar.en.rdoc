...
(a - b) - c
--
Note: arithmetic operators are usually left-associative.
...
Whether to omit or allow empty action calls.

  * result_var
  * no_result_var

Whether or not to allow the use of a local variable "result".
