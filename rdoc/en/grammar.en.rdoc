...
{ print val[0]
  puts val[1] }
--
However, there is some Ruby syntax which cannot be used inside an action block.
for instance, you cannot use '%' strings, here documents, or '%r' regexps.
...
the file.
This statement will never be used, I think.
